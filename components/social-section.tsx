...
export function SocialSection() {
  ...
  return (
    <section id="contact" className="relative w-full overflow-hidden bg-[#02050e] text-white">
      ...
      <div className="absolute inset-0 z-0 select-none pointer-events-none">
        ...
        />
        <div
          className="absolute bottom-10 right-1/4 h-[400px] w-[400px] rounded-full bg-[#00d2ff]/12 blur-[140px]"
          aria-hidden="true"
        />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-[1560px] px-6 sm:px-10 lg:px-14 xl:px-16 min-h-[550px] sm:min-h-[620px] lg:min-h-[680px] flex items-center justify-end py-16 sm:py-20 lg:py-24">
        ...
        >
          ...
          <h2 className="font-['MasterVictory'] text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-normal leading-tight select-none tracking-normal mb-3">
            ...
            <span className="text-[#00d2ff] drop-shadow-[0_0_24px_rgba(0,210,255,0.95)]">TOUCH</span>
          </h2>
          ...
          <div className="flex flex-wrap items-center gap-3 sm:gap-4 mb-8 sm:mb-10">
            ...
            <motion.a
              ...
              className="group relative flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-2xl bg-[#040814]/90 border-2 border-[#0099ff]/70 hover:border-[#00e5ff] text-[#00d2ff] hover:text-white transition-colors duration-300 shadow-[0_0_15px_rgba(0,140,255,0.35)] hover:shadow-[0_0_24px_rgba(0,210,255,0.85)]"
            >
            ...
            <motion.button
              ...
              className="group relative flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-2xl bg-[#040814]/90 border-2 border-[#0099ff]/70 hover:border-[#00e5ff] text-[#00d2ff] hover:text-white transition-colors duration-300 shadow-[0_0_15px_rgba(0,140,255,0.35)] hover:shadow-[0_0_24px_rgba(0,210,255,0.85)] cursor-pointer"
            >
              <svg viewBox="0 0 24 24" className="h-5 w-5 sm:h-6 sm:w-6 fill-current">
          ...
          {copiedText && (
            <motion.div
              ...
              exit={{ opacity: 0, y: 10 }}
              className="mb-4 inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#0099ff]/20 border border-[#00d2ff] text-xs font-mono text-[#00d2ff]"
            >

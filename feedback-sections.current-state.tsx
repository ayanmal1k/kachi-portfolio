...
export function FeedbackSections() {
  ...
  const devFeedbackItems: FeedbackItem[] = [
    {
      id: 'dev-1',
      title: 'Developer Feedback 1',
      platform: 'telegram',
      imageSrc: '/dev-feedback/download.jfif',
    },
    {
      id: 'dev-2',
      title: 'Developer Feedback 2',
      platform: 'telegram',
      imageSrc: '/dev-feedback/download (1).jfif',
    },
    {
      id: 'dev-3',
      title: 'Developer Feedback 3',
      platform: 'telegram',
  ...
  const communityTopItems: FeedbackItem[] = [
    {
      id: 'comm-1',
      title: 'Community Feedback 1',
      platform: 'telegram',
      imageSrc: '/people-feedback/download.jfif',
    },
    {
      id: 'comm-2',
      title: 'Community Feedback 2',
      platform: 'telegram',
      imageSrc: '/people-feedback/download (1).jfif',
    },
    {
      id: 'comm-3',
      title: 'Community Feedback 3',
      platform: 'telegram',
  ...
  const communityBottomItems: FeedbackItem[] = [
    {
      id: 'comm-4',
      title: 'Community Feedback 4',
      platform: 'telegram',
      imageSrc: '/people-feedback/download (3).jfif',
    },
    {
      id: 'comm-5',
      title: 'Community Feedback 5',
      platform: 'telegram',
